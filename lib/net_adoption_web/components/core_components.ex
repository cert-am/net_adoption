defmodule NetAdoptionWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NetAdoptionWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NetAdoptionWeb.Gettext, "errors", msg, opts)
    end
  end
